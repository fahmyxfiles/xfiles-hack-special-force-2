...
struct FItemSetInfos
{
	...
	int                                                PawnItemIDTable[ 0xC ];                           		// 0x0008 (0x0030) [0x0000000000000000]              
	int                                                WeaponItemIDTable1Pri[ 0xB ];                     		// 0x0038 (0x002C) [0x0000000000000000]              
	int                                                WeaponItemIDTable1Sec[ 0xB ];                     		// 0x0064 (0x002C) [0x0000000000000000]              
	int                                                WeaponItemIDTable2Pri[ 0xB ];                     		// 0x0090 (0x002C) [0x0000000000000000]              
	int                                                WeaponItemIDTable2Sec[ 0xB ];                     		// 0x00BC (0x002C) [0x0000000000000000]              
	int                                                WeaponItemIDTable3Pri[ 0xB ];                     		// 0x00E8 (0x002C) [0x0000000000000000]              
	int                                                WeaponItemIDTable3Sec[ 0xB ];                     		// 0x0114 (0x002C) [0x0000000000000000]              
};
...
struct FSRoomUserInfo
{
	...
	TArray< int >                                      WholeUserArray;                                   		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	int                                                InventoryInfo[ 0xC ];                             		// 0x0000 (0x0030) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FSPawnEffect
{
	...
	struct FName                                       PawnEffectState;                                  		// 0x0010 (0x0008) [0x0000000000000000]              
	float                                              Scale;                                            		// 0x0018 (0x0004) [0x0000000000000000]              
	struct FColor                                      Color;                                            		// 0x001C (0x0004) [0x0000000000000000]              
	float                                              Duration;                                         		// 0x0020 (0x0004) [0x0000000000000000]              
	unsigned long                                      PSCLoops : 1;                                     		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
	TArray< float >                                    Timing;                                           		// 0x0028 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FSUserResult
{
	...
	float                                              VipRoomCareExpValue;                              		// 0x006C (0x0004) [0x0000000000000000]              
	float                                              VipRoomCareSpValue;                               		// 0x0070 (0x0004) [0x0000000000000000]              
...
// ScriptStruct SFGame.SFCustomWeaponPreview.sMuzzleFlashPlayType
// 0x0014
struct FsMuzzleFlashPlayType
{
...
{
	struct FString                                     msg[ 0x4 ];                                       		// 0x0000 (0x0030) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	unsigned long                                      bIsVisible : 1;                                   		// 0x0030 (0x0004) [0x0000000000008002] [0x00000001] ( CPF_Const | CPF_Localized )
};
...
{
	struct FString                                     CustomButtonText;                                 		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     CustomButtonToolTip;                              		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
// ScriptStruct SFGame.SFGFxDialog_EventList.SPromoIDInfo
// 0x0010
...
// 0x0010
struct FSCategorySet
{
	struct FString                                     TabString;                                        		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UClass*                                      TabClass;                                         		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct FsMuzzleColorUpgrade
{
	...
	struct FVector                                     MuzzleColor_04;                                   		// 0x003C (0x000C) [0x0000000000000000]              
};
...
struct FSMsgrNotice
{
	...
	TArray< int >                                      ExtraArray;                                       		// 0x0038 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
