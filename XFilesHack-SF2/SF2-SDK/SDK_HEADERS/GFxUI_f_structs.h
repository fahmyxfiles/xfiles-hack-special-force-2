...
// [0x00020002] 
struct UGFxMoviePlayer_execRemoveExternalInterfaceListen_Parms
{
...
// [0x00020002] 
struct UGFxMoviePlayer_execAddExternalInterfaceListen_Parms
{
	class UObject*                                     Obj;                                              		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
...
// [0x00020802] ( FUNC_Event )
struct UGFxMoviePlayer_eventConsoleCommand_Parms
{
...
// [0x00020400] ( FUNC_Native )
struct UGFxMoviePlayer_execSetDefaultIME_Parms
{
};

// Function GFxUI.GFxMoviePlayer.IsEnableDefaultIME
// [0x00020800] ( FUNC_Event )
struct UGFxMoviePlayer_eventIsEnableDefaultIME_Parms
{
...
// [0x00020800] ( FUNC_Event )
struct UGFxMoviePlayer_eventIsInDefaultIME_Parms
{
	struct FString                                     strIME;                                           		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	unsigned long                                      ReturnValue : 1;                                  		// 0x000C (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};

// Function GFxUI.GFxMoviePlayer.IMETextInputUpdated
// [0x00020800] ( FUNC_Event )
struct UGFxMoviePlayer_eventIMETextInputUpdated_Parms
{
};
...
// [0x00020800] ( FUNC_Event )
struct UGFxMoviePlayer_eventRestoreDevice_Parms
{
};
...
{
	struct FString                                     ASClass;                                          		// 0x0000 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
	class UClass*                                      Type;                                             		// 0x000C (0x0004) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
	TArray< struct FASValue >                          args;                                             		// 0x0010 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
...
struct UGFxMoviePlayer_execSetFocus_Parms
{
...
struct UGFxObject_execANSILength_Parms
{
...
struct UGFxClikWidget_execAS3AddEventListener_Parms
{
	...
	unsigned long                                      useCapture : 1;                                   		// 0x0010 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
	int                                                listenerPriority;                                 		// 0x0014 (0x0004) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
	unsigned long                                      useWeakReference : 1;                             		// 0x0018 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
};
...
struct UGFxClikWidget_execAddEventListener_Parms
{
	...
	unsigned long                                      useCapture : 1;                                   		// 0x0014 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
	int                                                listenerPriority;                                 		// 0x0018 (0x0004) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
	unsigned long                                      useWeakReference : 1;                             		// 0x001C (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
	// class UGFxObject*                               O;                                                		// 0x0020 (0x0004) [0x0000000000000000]              
	// class UGFxObject*                               funcobj;                                          		// 0x0024 (0x0004) [0x0000000000000000]              
	// struct FString                                  TypeString;                                       		// 0x0028 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
