...
public:
	...
	unsigned char                                      UnknownData00[ 0x138 ];                           		// 0x0A88 (0x0138) MISSED OFFSET
...
{
public:
	unsigned char                                      LinkMode;                                         		// 0x0224 (0x0001) [0x0000000000000000]              
	unsigned char                                      InLineMode;                                       		// 0x0225 (0x0001) [0x0000000000000000]              
	unsigned char                                      OutLineMode;                                      		// 0x0226 (0x0001) [0x0000000000000000]              
	unsigned char                                      ReceiveMode;                                      		// 0x0227 (0x0001) [0x0000000000000000]              
	struct FPointer                                    Socket;                                           		// 0x0228 (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                Port;                                             		// 0x022C (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    RemoteSocket;                                     		// 0x0230 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    PrivateResolveInfo;                               		// 0x0234 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                DataPending;                                      		// 0x0238 (0x0004) [0x0000000000000002]              ( CPF_Const )
...
{
public:
	unsigned char                                      LinkState;                                        		// 0x023C (0x0001) [0x0000000000000000]              
	struct FIpAddr                                     RemoteAddr;                                       		// 0x0240 (0x0008) [0x0000000000000000]              
	class UClass*                                      AcceptClass;                                      		// 0x0248 (0x0004) [0x0000000000000000]              
	TArray< unsigned char >                            SendFIFO;                                         		// 0x024C (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     RecvBuf;                                          		// 0x0258 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
{
public:
	struct FPointer                                    VoiceEngine;                                      		// 0x00D0 (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	int                                                MaxLocalTalkers;                                  		// 0x00D4 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxRemoteTalkers;                                 		// 0x00D8 (0x0004) [0x0000000000004000]              ( CPF_Config )
	unsigned long                                      bIsUsingSpeechRecognition : 1;                    		// 0x00DC (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	class UOnlineGameInterfaceImpl*                    GameInterfaceImpl;                                		// 0x00E0 (0x0004) [0x0000000000000000]              
...
public:
	...
	unsigned long                                      bBestFitTeamAssignment : 1;                       		// 0x00A0 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned char                                      BeaconState;                                      		// 0x00A4 (0x0001) [0x0000000000000002]              ( CPF_Const )
	struct FScriptDelegate                             __OnReservationChange__Delegate;                  		// 0x00A8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnReservationsFull__Delegate;                   		// 0x00B4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnClientCancellationReceived__Delegate;         		// 0x00C0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
// 0x001C (0x503C - 0x5020)
class UTcpipConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[ 0x1C ];                            		// 0x5020 (0x001C) MISSED OFFSET
...
{
public:
	unsigned long                                      AllowPlayerPortUnreach : 1;                       		// 0x0208 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	unsigned long                                      LogPortUnreach : 1;                               		// 0x020C (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
...
// 0x014C (0x03B0 - 0x0264)
class AWebServer : public ATcpLink
{
public:
	struct FString                                     ServerName;                                       		// 0x0264 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     Applications[ 0xA ];                              		// 0x0270 (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     ApplicationPaths[ 0xA ];                          		// 0x02E8 (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	unsigned long                                      bEnabled : 1;                                     		// 0x0360 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	int                                                ListenPort;                                       		// 0x0364 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxConnections;                                   		// 0x0368 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                DefaultApplication;                               		// 0x036C (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ExpirationSeconds;                                		// 0x0370 (0x0004) [0x0000000000004000]              ( CPF_Config )
	struct FString                                     ServerURL;                                        		// 0x0374 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebApplication*                             ApplicationObjects[ 0xA ];                        		// 0x0380 (0x0028) [0x0000000000000000]              
	int                                                ConnectionCount;                                  		// 0x03A8 (0x0004) [0x0000000000000000]              
	int                                                ConnId;                                           		// 0x03AC (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 39170 ];
...
// 0x0030 (0x0294 - 0x0264)
class AWebConnection : public ATcpLink
{
public:
	class AWebServer*                                  WebServer;                                        		// 0x0264 (0x0004) [0x0000000000000000]              
	struct FString                                     ReceivedData;                                     		// 0x0268 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebRequest*                                 Request;                                          		// 0x0274 (0x0004) [0x0000000000000000]              
	class UWebResponse*                                Response;                                         		// 0x0278 (0x0004) [0x0000000000000000]              
	class UWebApplication*                             Application;                                      		// 0x027C (0x0004) [0x0000000000000000]              
	unsigned long                                      bDelayCleanup : 1;                                		// 0x0280 (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                RawBytesExpecting;                                		// 0x0284 (0x0004) [0x0000000000000000]              
	int                                                MaxValueLength;                                   		// 0x0288 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxLineLength;                                    		// 0x028C (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ConnId;                                           		// 0x0290 (0x0004) [0x0000000000000000]              
